...
import {
    Activity, Mail, Lock, Eye, EyeOff, ArrowRight, ArrowLeft,
    Building2, BarChart3, Upload, Cpu, CheckCircle2, Users, Globe
} from "lucide-react";
    ...
    return (
        <div style={{ display: "flex", minHeight: "100vh", backgroundColor: "#050508", fontFamily: "Inter, sans-serif" }}>
            ...
            <div style={{
                ...
                background: "linear-gradient(135deg, #050814 0%, #050508 60%)",
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                    ...
                    <Link href="/" style={{ display: "flex", alignItems: "center", gap: 12, textDecoration: "none" }}>
                        <div style={{ width: 44, height: 44, borderRadius: 14, background: "linear-gradient(135deg, #3b82f6, #22d3ee)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 30px rgba(59,130,246,0.3)" }}>
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                    <div style={{ display: "inline-block", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", padding: "6px 14px", borderRadius: 100, border: "1px solid rgba(59,130,246,0.3)", background: "rgba(59,130,246,0.1)", color: "#60a5fa", marginBottom: 24 }}>
                    ...
                    <h2 style={{ fontSize: 52, fontWeight: 900, color: "white", lineHeight: 1.05, letterSpacing: "-1.5px", marginBottom: 16 }}>
                        Supercharge<br />
                        <span style={{ background: "linear-gradient(90deg, #60a5fa, #22d3ee)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>your lab&apos;s</span><br />
                        AI pipeline.
                    </h2>
                    <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 16, lineHeight: 1.7, maxWidth: 360, marginBottom: 36 }}>
                        Integrate your diagnostic lab with HealthAI to automatically parse and extract data from all patient reports.
                    </p>
                ...
                <div style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "rgba(255,255,255,0.2)" }}>
                    <Globe size={14} color="rgba(96,165,250,0.5)" />
                    Enterprise SLA · SOC 2 Compliant · Multi-region
                </div>
            </div>
                ...
                <div style={{ width: "100%", maxWidth: 420 }}>
                    ...
                    <div style={{ display: "flex", gap: 6, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 6, marginBottom: 36 }}>
                        {(["login", "signup"] as const).map((m) => (
                            <button key={m} onClick={() => setMode(m)} style={{
                                flex: 1, padding: "10px 0", borderRadius: 11, fontSize: 13, fontWeight: 600, border: "none", cursor: "pointer", transition: "all 0.25s",
                                background: mode === m ? "linear-gradient(135deg, #3b82f6, #22d3ee)" : "transparent",
                                color: mode === m ? "white" : "rgba(255,255,255,0.35)",
                                boxShadow: mode === m ? "0 4px 20px rgba(59,130,246,0.25)" : "none",
                            }}>
                                {m === "login" ? "Sign In" : "Register Center"}
                            </button>
                        ))}
                    </div>
                    ...
                    <div style={{ marginBottom: 28 }}>
                        <h1 style={{ fontSize: 28, fontWeight: 800, color: "white", letterSpacing: "-0.5px", marginBottom: 8 }}>
                            {mode === "login" ? "Center Sign In" : "Register your center"}
                        </h1>
                        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", lineHeight: 1.6 }}>
                            {mode === "login" ? "Access your diagnostic center&apos;s AI portal." : "Set up your lab and begin AI-powered report parsing."}
                        </p>
                    </div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                                ...
                                <>
                                    <div>
                                        ...
                                        <div style={{ position: "relative" }}>
                                            <span style={{ position: "absolute", left: 14, top: "50%", transform: "translateY(-50%)", color: "rgba(255,255,255,0.2)", display: "flex" }}><Building2 size={15} /></span>
                                            <input type="text" required placeholder="Apollo Diagnostics, Chennai" style={inputStyle} />
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div>
                                ...
                                <div style={{ position: "relative" }}>
                                    ...
                                    <input type="email" required placeholder="center@yourdomain.com" style={inputStyle} />
                                </div>
                            </div>
                            ...
                            <div>
                                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                                    ...
                                    {mode === "login" && <Link href="#" style={{ fontSize: 12, color: "#60a5fa", textDecoration: "none" }}>Forgot password?</Link>}
                                </div>
                                <div style={{ position: "relative" }}>
                            ...
                            {mode === "signup" && (
                                <div>
                                    ...
                                    <select style={{ ...inputStyle, paddingLeft: 14, color: "rgba(255,255,255,0.6)" }}>
                                        <option value="">Select your center size...</option>
                                        <option>Tier 1 — Enterprise Lab (500+ reports/day)</option>
                                        <option>Tier 2 — Medium Lab (100–500 reports/day)</option>
                                        <option>Tier 3 — Small Clinic (&lt;100 reports/day)</option>
                                    </select>
                                </div>
                            )}

                            <button type="submit" style={{ width: "100%", padding: "14px", borderRadius: 13, border: "none", background: "linear-gradient(135deg, #3b82f6, #22d3ee)", color: "white", fontWeight: 700, fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, boxShadow: "0 8px 30px rgba(59,130,246,0.25)", marginTop: 4 }}>
                                {mode === "login" ? "Sign In to Center Portal" : "Register Your Center"}
                                <ArrowRight size={16} />
                            </button>
                        </div>
                    </form>
                    ...
                    <div style={{ marginTop: 28, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, fontSize: 11, color: "rgba(255,255,255,0.2)" }}>
                        ...
                        SOC 2 compliant · Enterprise SLA · Multi-region
                    </div>
                </div>
            </div>
        </div>
