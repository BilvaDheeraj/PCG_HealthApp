...
import {
    ...
    User, Heart, TrendingUp, Brain, CheckCircle2, MessageSquare
} from "lucide-react";
            ...
            <div style={{
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                    ...
                    <h2 style={{ fontSize: 52, fontWeight: 900, color: "white", lineHeight: 1.05, letterSpacing: "-1.5px", marginBottom: 16 }}>
                        Your health,<br />
                        <span style={{ background: "linear-gradient(90deg, #f97316, #fbbf24)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>intelligently</span><br />
                        decoded.
                    </h2>
                    <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 16, lineHeight: 1.7, maxWidth: 360, marginBottom: 36 }}>
                        Upload any lab report and get instant AI-powered insights, trends, and personalised diet plans.
                    </p>
                ...
                <div style={{ position: "relative", zIndex: 1, display: "flex", alignItems: "center", gap: 16 }}>
                    <div style={{ display: "flex" }}>
                        {["P", "R", "S", "A"].map((l, i) => (
                            <div key={l} style={{ width: 36, height: 36, borderRadius: "50%", border: "2px solid #050508", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, color: "white", fontWeight: 700, marginLeft: i > 0 ? -10 : 0, background: ["#f97316", "#ec4899", "#14b8a6", "#a855f7"][i] }}>
                                {l}
                            </div>
                        ))}
                    </div>
            ...
            <div style={{ flex: 1, overflowY: "auto", display: "flex", justifyContent: "center", padding: "48px 32px" }}>
                <div style={{ width: "100%", maxWidth: 420 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 36 }} className="lg:hidden">
                        <Link href="/auth" style={{ color: "rgba(255,255,255,0.4)", display: "flex" }}>
                            <ArrowLeft size={18} />
                        </Link>
                    ...
                    <div style={{ marginBottom: 28 }}>
                        ...
                        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", lineHeight: 1.6 }}>
                            {mode === "login" ? "Sign in to access your personal health AI dashboard." : "Create your free patient account and upload your first report."}
                        </p>
                    </div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                            ...
                            <div>
                                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
                                    ...
                                    {mode === "login" && <Link href="#" style={{ fontSize: 12, color: "#f97316", textDecoration: "none" }}>Forgot password?</Link>}
                                </div>
                                <div style={{ position: "relative" }}>
                            ...
                            {mode === "signup" && (
                                <div>
                                    ...
                                    <div style={{ position: "relative" }}>
                                        ...
                                        <button type="button" onClick={() => setShowConfirm(!showConfirm)} style={{ position: "absolute", right: 14, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", color: "rgba(255,255,255,0.2)", cursor: "pointer", display: "flex" }}>
                            ...
                            {mode === "signup" && (
                                <label style={{ display: "flex", alignItems: "flex-start", gap: 10, cursor: "pointer" }}>
                                    <div style={{ width: 16, height: 16, borderRadius: 4, border: "1px solid rgba(255,255,255,0.15)", flexShrink: 0, marginTop: 2 }} />
                                    <span style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", lineHeight: 1.6 }}>
                                        I agree to the <Link href="/legal/terms" style={{ color: "rgba(255,255,255,0.65)", textDecoration: "underline" }}>Terms</Link> and <Link href="/legal/privacy" style={{ color: "rgba(255,255,255,0.65)", textDecoration: "underline" }}>Privacy Policy</Link>
                                    </span>
                                </label>
                            )}
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                        {["Google", "Apple"].map((p) => (
                            <button key={p} style={{ padding: "11px", borderRadius: 12, border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.03)", color: "rgba(255,255,255,0.5)", fontSize: 13, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
                                {p}
                            </button>
                        ))}
                    </div>
