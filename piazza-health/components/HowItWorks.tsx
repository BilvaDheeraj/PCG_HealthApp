...
const steps = [
    {
        ...
        desc: "Visit Dr. Lal PathLabs or Metropolis near you. A 15-minute blood draw. 100+ biomarkers analyzed by top labs.",
        icon: "🩸",
    ...
    },
    {
        ...
        desc: "AI-powered recommendations — diet, exercise, sleep, and supplements personalized for your unique biology.",
        icon: "📋",
    ...
    },
    {
        ...
        desc: "Doctor messaging, supplements, and add-on diagnostics — all in one platform, anytime you need it.",
        icon: "🌐",
                    ...
                    {steps.map((s, i) => (
                        <div key={s.num} className="fade-up" style={{ transitionDelay: `${0.15 * i}s` }}>
                            <div style={{
                                ...
                                aspectRatio: "4/3", position: "relative", background: "#f0f0f0",
                            }}>
