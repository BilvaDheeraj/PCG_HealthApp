        ...
        <section id="reviews" style={{ background: "#0a0a0a", padding: "100px 0" }}>
            <div className="container">
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 48, flexWrap: "wrap", gap: 20 }}>
                    ...
                    <Link href="/reviews" className="btn-outline fade-up" style={{ transitionDelay: "0.2s" }}>See all reviews →</Link>
                </div>
                    ...
                    {reviews.map((r, i) => (
                        <div key={r.name}
                            ...
                            style={{
                                ...
                                borderRadius: 20, padding: 28, cursor: "pointer", transition: "all 0.3s ease",
                            }}
                            onMouseEnter={e => {
