        ...
        <section className="section-light" style={{ position: "relative", zIndex: 1, background: "#f8f8f8", padding: "100px 0" }}>
            <div className="container">
                ...
                <h2 className="display-md fade-up" style={{ color: "#0a0a0a", marginBottom: 16, transitionDelay: "0.1s" }}>
                    100+ labs tested every year
                </h2>
                <a href="#biomarkers" className="btn-ghost-dark fade-up" style={{ marginBottom: 64, transitionDelay: "0.2s" }}>
                ...
                <div style={{ marginTop: 64 }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
                        {["Heart Health", "Liver", "Kidney", "Hormones", "Thyroid", "Vitamins & Minerals", "Blood Sugar", "Cholesterol", "Immunity", "Cancer Screening"]
                            .map((cat, i) => (
                                <span key={cat} className="fade-up"
                                    style={{
                                        padding: "8px 18px", borderRadius: "100px",
                                        border: "1px solid rgba(0,0,0,0.1)", fontSize: 13, fontWeight: 500,
