        ...
        <section style={{
            ...
            <div className="container" style={{ position: "relative", zIndex: 2, textAlign: "center", maxWidth: 900 }}>
                ...
                <p className="body-lg fade-up" style={{
                    ...
                    color: "rgba(255,255,255,0.6)", marginBottom: 36, maxWidth: 680, margin: "0 auto 36px",
                }}>
                    100+ biomarkers · Every year · Detect early signs of 1,000+ conditions · All for just{" "}
                    <strong style={{ color: "#fff" }}>₹1,499/month</strong>
                </p>
            ...
            <div style={{
                ...
                color: "rgba(255,255,255,0.4)", fontSize: 12, letterSpacing: "0.1em",
            }}>
