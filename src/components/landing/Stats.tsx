...
function CountUp({ target, suffix = "", prefix = "" }: { target: number; suffix?: string; prefix?: string }) {
  ...
  return (
    <div ref={ref} className="stat-number" style={{ background: "linear-gradient(135deg, #fff 0%, rgba(255,255,255,0.6) 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
      {prefix}
      {count}
      {suffix}
    </div>
    ...
    <section style={{ position: "relative", zIndex: 1, background: "transparent", padding: "120px 0" }}>
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 80 }}>
          ...
          <h2 className="display-md fade-up" style={{ color: "#fff", transitionDelay: "0.1s" }}>The numbers speak for themselves</h2>
        </div>
