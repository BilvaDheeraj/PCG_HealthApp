...
const categories = [
  { id: "heart", emoji: "", label: "Heart & Vascular", count: 29, markers: ["Galectin-3 Test", "HDL Cholesterol Test", "LDL Cholesterol Test", "Total Cholesterol", "Apolipoprotein B (ApoB)", "Triglycerides Test", "Lipoprotein (a)", "Atherogenic Index of Plasma", "And 21 more..."] },
  ...
  { id: "hormones", emoji: "", label: "Sex Hormones", count: 17, markers: ["Testosterone, Total", "Estradiol", "FSH", "LH", "DHEA-S", "SHBG", "And 11 more..."] },
