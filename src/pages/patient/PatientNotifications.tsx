...
import { Bell, AlertTriangle, CheckCircle, Calendar, TrendingUp, Info, Trash2, Loader2 } from "lucide-react";
...
const typeIcons: Record<string, JSX.Element> = {
  ...
  report: <Info className="w-5 h-5 text-primary" />,
};
...
const PatientNotifications = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:8000/api/patient/notifications")
      .then(res => res.json())
      .then(data => {
