...
import {
  ...
  XCircle, Eye, MoreHorizontal, TrendingUp, Activity, Loader2
} from "lucide-react";
import {
...
const AdminDashboard = () => {
  ...
  const stats = data?.stats || { total_users: 0, reports_processed: 0, flagged_reports: 0, active_centers: 0 };
  const userGrowth = data?.userGrowth || [];
  const healthTrends = data?.healthTrends || [];
  const flaggedReports = data?.flaggedReports || [];
  const deficiencyData = data?.deficiencyData || [];
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            ...
            value={stats.flagged_reports.toString()}
          ...
          <StatCard
            ...
            value={stats.active_centers.toString()}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="space-y-3">
              {flaggedReports.map((report: any, i: number) => (
                <motion.div
                  key={report.id}
