    ...
    <section id="membership" className="section-light" style={{ position: "relative", zIndex: 1, background: "#fff", padding: "100px 0" }}>
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          <h2 className="display-md fade-up" style={{ color: "#0a0a0a", transitionDelay: "0.1s" }}>More than a blood test</h2>
          <p className="body-lg fade-up" style={{ color: "#666", marginTop: 16, maxWidth: 560, margin: "16px auto 0", transitionDelay: "0.2s" }}>Piazza manages your entire health ecosystem in one place</p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
          {features.map((f, i) => (
            <div key={f.title} className="card-light fade-up" style={{ transitionDelay: `${0.1 * i}s`, position: "relative", overflow: "hidden" }}>
              <div className="feature-accent" style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: "linear-gradient(90deg, #FF5500, #FF8C00)", transform: "scaleX(0)", transformOrigin: "left", transition: "transform 0.4s ease" }} />
